...
Stage 11 introduces Agent-to-Agent collaboration and A2A protocol concepts. Stage 13 asks what changes when that Agent becomes a real network service with public discovery, authentication, task state, streaming, replicas, and shutdown behavior.
...
This is the same service-identity principle used by Stage 13's threads/jobs.
