...
Stage 09 从一个听起来很无聊、但非常能避免线上“精彩事故”的事实开始：
...
为什么保留 type？因为 Stage 10 observability 需要回答：
...
Stage 09 故意不猜“每一个 `TypeError` 都一定来自坏 ToolCall”。
...
6. 为什么在 Stage 10 observability 前就需要 structured failure code。
