...
Stage 09 uses this idea around async Tool execution.
...
Stage 09 deliberately does not convert `asyncio.CancelledError` into:
...
Stage 09 focuses on the retry/timeout primitives; Stage 10 will make fallback/degradation observable.
