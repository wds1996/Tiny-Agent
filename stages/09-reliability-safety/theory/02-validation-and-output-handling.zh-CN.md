...
对真实 dynamic Tool schema，Stage 09 加入：
...
Stage 09 的 full adapter 会把 malformed application schema 视为 developer error，而不是 normal ToolCall failure。
