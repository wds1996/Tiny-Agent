...
Stage 07 already created budgets; Stage 08 turns their outcomes into measurements.
...
Tiny-Agent Stage 08 keeps the first trajectory object intentionally small, but the trace model gives future evaluators a place to attach these state/policy signals.

---

## 10. Correct final answer + bad trajectory

This is the signature Stage 08 example:
