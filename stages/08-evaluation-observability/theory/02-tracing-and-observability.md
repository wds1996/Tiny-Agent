...
Stage 07 made execution safer. Stage 08 needs to answer:
...
That would undo the Stage 07 rule:
...
`ObservedGuardedToolExecutor` wraps Stage 07:
...
Stage 08 only needs enough of that architecture to make the boundary clear.
