...
因此 Stage 15 把 evaluation 定义成对 **evidence usage 与 trajectory** 的契约，而不是只对 prose 做一次“观感评分”。
...
Capstone 继续复用 Stage 10 `LocalTracer`，记录 nested spans，并允许以后适配 OpenTelemetry / LangSmith。
