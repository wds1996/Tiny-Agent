...
Stage 15 is where the boundaries from Stages 06 and 07 stop being isolated examples and become product requirements.
...
The Stage 11 `DelegationPolicy` explicitly permits:
