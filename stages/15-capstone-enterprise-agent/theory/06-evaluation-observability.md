...
A research Agent can fail while sounding excellent. Stage 15 therefore treats evaluation as a contract over **evidence use and trajectory**, not a vibe check over prose quality.
...
The capstone reuses `LocalTracer` from Stage 10. It records nested spans and can later be adapted to OpenTelemetry/LangSmith.
