...
输出仍可能十分流畅。所以 critical constraint 应显式保留；高价值 task 可以像 Stage 07 validation Tool args 一样 validate delegation contract。
...
Supervisor 还可能检查 schema、evidence coverage、constraint、policy、quality threshold。Stage 08 evaluator 可直接复用。
