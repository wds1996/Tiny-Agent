# Stage 09 Review Questions & Exercises
...
## 53. Add a worker timeout without duplicating Stage 07 retry policy.
...
## 57. Add trace spans around `delegate()` and `handoff()` using the Stage 08 tracer protocol.
...
Before you say you understand Stage 09, make sure you can explain these without notes:
