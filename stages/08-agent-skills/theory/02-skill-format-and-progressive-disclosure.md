...
This is the same context-engineering principle from Stage 07 applied to procedural knowledge.
...
Stage 12 provides the controlled compute boundary.
...
Stage 12 uses the same principle for Agent workspaces.
