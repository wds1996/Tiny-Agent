...
所以 Stage 10 在决定 release 是否可接受前，会把 quality、reliability、safety、latency、cost 分开看。
...
Stage 09 已产生 classification；Stage 10 负责 aggregate/compare。
...
Stage 06 context management 和 Stage 04 RAG 会直接影响 Stage 10 usage metric。
