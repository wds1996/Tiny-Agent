...
Stage 10 therefore treats quality, reliability, safety, latency, and cost as separate signals before deciding whether a release is acceptable.
...
Stage 09 already produces the classifications needed for these metrics.

Stage 10's job is to aggregate and compare them.
...
Stage 06 context management and Stage 04 RAG design directly affect Stage 10 usage metrics.
