...
Stage 09 介绍 Agent-to-Agent collaboration 与 A2A protocol concept。Stage 10 继续追问：当这个 Agent 真正变成一个网络服务，拥有 public discovery、authentication、task state、streaming、replica 与 shutdown 行为时，哪些 production concern 会出现？
