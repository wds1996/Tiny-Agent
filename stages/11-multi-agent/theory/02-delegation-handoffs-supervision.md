...
For high-value tasks, validate delegated task contracts just as Stage 09 validates Tool arguments.
...
Stage 10 evaluators can often be reused here.
...
Stage 11 therefore adds explicit handoff budgets and repeated-edge limits.
