...
Stage 09's safety rules therefore become **more important**, not less important, when another Agent is introduced.
...
Stage 09 remains the execution boundary.
...
Stage 11 introduces coordination-specific call/handoff limits and reuses Stage 09's broader resource-governance principles.
...
So handoff filters and context projection should preserve the Stage 09 distinction:
...
But, as Stage 10 taught, do not automatically log the complete delegated prompt or private context.
...
That one sentence connects Stage 11 directly back to Stage 09.
