...
因此 Stage 11 会通过多个边界暴露同一个 domain Agent，同时避免复制 research logic。
...
## Stage 10 Service Constraints 仍然存在
...
Stage 11 Dockerfile 负责 package application，并启动 FastAPI example。
