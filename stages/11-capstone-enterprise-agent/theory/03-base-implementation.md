...
The initial draft goes through the Stage 09 `TeamRuntime`:
...
Raw prompts/outputs are not captured by default because Stage 08 already taught that observability must not undo Stage 07's privacy boundary.
