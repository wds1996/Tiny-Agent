...
Stage 06A context engineering becomes essential rather than optional optimization.
...
Use Stage 07/10 idempotency, transactions, deduplication, and approval rules for side effects.
