...
Stage 07 treats this as an architecture problem.
...
Stage 07 converts that principle into execution governance.
...
Stage 07 includes a tiny detector for phrases like:
...
Stage 07's sandbox example uses a child process because a process can be terminated after a deadline.
