...
Stage 07 adds the missing production rule:
...
Stage 07 teaches the mechanism first:
...
For real dynamic Tool schemas Stage 07 adds:
...
Stage 07's full adapter therefore treats malformed application schema as a developer error rather than a normal ToolCall failure.
