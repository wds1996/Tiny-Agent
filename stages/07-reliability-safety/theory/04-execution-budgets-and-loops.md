...
Tiny-Agent Stage 07 introduces a simple ledger:
...
Therefore Stage 07's ledger can record:
...
Stage 08 will make these values observable.
...
Stage 07 adds exact-call fingerprints:
...
This is why Stage 07 treats budgets as runtime policy, not merely cost optimization.
